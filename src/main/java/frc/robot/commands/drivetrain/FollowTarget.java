...
public class FollowTarget extends Command {
    ...
    protected void execute() {
        ...
        xSpeed = 0.0;//OI.getInstance().applyPID(OI.getInstance().VISION_X_SYSTEM, Vision.getInstance().centerX(), targetCenter, kPVision, kIVision, kDVision, .5, -.5);
        ySpeed = 0.0;//OI.getInstance().applyPID(OI.getInstance().VISION_Y_SYSTEM, distanceFromMethod, targetDistance, kPVision, kIVision, kDVision, .5, -.5);
        //if (distanceFromMethod >= 40.0 /*needs a better way to go about this*/) {
